...
// Brand marks are solid glyphs, so these are filled paths on a 24x24 grid
// rather than the stroked icons used elsewhere in the site.
const socials = [
  {
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {socials.map((s) => (
                <a
                  ...
                  className="focus-ring inline-flex items-center gap-2 rounded-full border px-4 py-2 text-xs transition-colors hover:border-brand-500 hover:text-brand-600"
                >
                  <svg
                    viewBox="0 0 24 24"
